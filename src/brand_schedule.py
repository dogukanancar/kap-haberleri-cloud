...
GITHUB_CHECK_INTERVAL = "Belirlenen saatlerde (GitHub Actions)"
...
def parse_send_times(raw: str) -> list[str]:
    ...
    if not parts:
        raise ValueError("En az bir kontrol saati gerekli.")
...
def save_schedule_settings(*, send_times: str) -> BrandScheduleConfig:
...
def record_scheduled_send(slot: str) -> None:
    ...
    repository.set_setting(
        "brand_bugun_gonderilen_saatler",
